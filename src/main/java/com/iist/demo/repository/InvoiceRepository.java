...
public class InvoiceRepository {
	...
	private final String SQL_QUERY_CREATE = "INSERT INTO tbl_invoices (id, amount, status, reg_user, reg_dttm)"
			+ " VALUES(:id, :amount, :status, :regUser, :regDttm)";
	
	public int createList(Invoice invoice) {
		return jdbcTemplate.update(SQL_QUERY_CREATE, new BeanPropertySqlParameterSource(invoice));
	}
	
	public List<Invoice> gets(List<String> status, int pageSize,
